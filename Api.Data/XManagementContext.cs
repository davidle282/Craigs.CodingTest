...
namespace Api.Data
{
    public partial class XManagementContext : DbContext
    {
        public IConfiguration Configuration { get; }

        public XManagementContext()
        {
        }

        public XManagementContext(DbContextOptions<XManagementContext> options, IConfiguration configuration)
            : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrderItem>(entity =>
            {
                entity.HasKey(e => new { e.OrderId, e.ItemId })
                    .HasName("PK__order_it__837942D4E6D55E63");
            ...
            modelBuilder.Entity<Staff>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email, "UQ__staffs__AB6E61642DA05CCF")
                    .IsUnique();
            ...
            modelBuilder.Entity<Stock>(entity =>
            {
                entity.HasKey(e => new { e.StoreId, e.ProductId })
                    .HasName("PK__stocks__E68284D3CEA09B73");
